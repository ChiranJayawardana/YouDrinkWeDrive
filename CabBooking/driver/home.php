<style>
    ...
    .driver-bookings-hero-content {
        position: relative;
        z-index: 1;
        text-align: center;
    }
    .driver-bookings-hero h1 {
        font-size: 2.5rem;
        font-weight: 800;
...
<section class="driver-bookings-hero">
    <div class="container driver-bookings-hero-content">
        <h1><i class="fas fa-tasks"></i> My Booking List</h1>
        <p>Manage and track all your assigned bookings</p>
    </div>
</section>

<section class="driver-bookings-section">
    <div class="container">
        <div id="driver-bookings-container">
            <?php 
...
<script>
    $(function(){
        ...
        $('.driver-booking-card').each(function(index){
            $(this).css({
                'opacity': '0',
