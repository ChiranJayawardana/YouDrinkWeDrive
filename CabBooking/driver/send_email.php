...
function send_email($to, $subject, $body) {
    ...
    try {
        ...
        $mail->Username   = 'chijayboy@gmail.com';               // SMTP username
        $mail->Password   = 'grks hogp wwxz azca';                  // SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;           // Enable TLS encryption
        $mail->Port       = 587;                                    // TCP port to connect to

        //Recipients
        $mail->setFrom('chijayboy@gmail.com', 'You Drink We Drive');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Create Google Maps link with pickup and drop-off locations
    $pickup_encoded = urlencode($pickup_zone);
    $dropoff_encoded = urlencode($drop_zone);
    $trackingLink = "https://www.google.com/maps/dir/?api=1&origin={$pickup_encoded}&destination={$dropoff_encoded}&travelmode=driving";
    
    // Review link
    $reviewLink = "https://forms.gle/UcastGpDJXr2zmnLA";
    ...
    if ($status == 1) {
            ...
            <div style=\"background-color:#f2f2f2;padding:20px;font-family:Arial,sans-serif;\">
                <div style=\"background-color:#fff;padding:20px;border-radius:10px;border:1px solid #ddd;max-width:600px;margin:auto;\">
                    ...
                    <div style=\"text-align:center;margin:20px 0;\">
                        <a href=\"$trackingLink\" style=\"display:inline-block;padding:12px 25px;font-size:16px;color:#fff;background-color:#007bff;border-radius:5px;text-decoration:none;\">Track Location</a>
                    </div>
        ...
        $body = "
            <div style=\"background-color:#f2f2f2;padding:20px;font-family:Arial,sans-serif;\">
                <div style=\"background-color:#fff;padding:20px;border-radius:10px;border:1px solid #ddd;max-width:600px;margin:auto;\">
                    <div style=\"text-align:center;margin-bottom:20px;\">
                        <img src=\"https://img.icons8.com/ios-filled/100/4caf50/checked-2.png\" alt=\"Ride Completed\" style=\"width:100px;height:auto;\" />
                    </div>
                    <p style=\"font-size:16px;color:#333;text-align:center;\">
                        Hi $firstname,<br><br>
                    ...
                    <div style=\"text-align:center;margin:20px 0;\">
                        <a href=\"$reviewLink\" style=\"display:inline-block;padding:12px 25px;font-size:16px;color:#fff;background-color:#007bff;border-radius:5px;text-decoration:none;\">Rate Us</a>
                    </div>
                    <div style=\"text-align:center;color:#888;margin-top:30px;\">
                        <b>You Drink We Drive</b><br>
                    </div>
