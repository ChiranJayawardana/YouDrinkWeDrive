<style>
/* Purple Glassmorphism Navigation - Matching System Theme */
#topNavBar {
...
@media (max-width: 992px) {
    ...
    .navbar-collapse {
        background: linear-gradient(135deg, rgba(147, 51, 234, 0.98) 0%, rgba(168, 85, 247, 0.98) 100%);
        margin-top: 1rem;
        padding: 1.25rem;
        border-radius: 14px;
            ...
            <div class="d-flex align-items-center ms-lg-3">
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a class="dropdown-item" href="<?= base_url ?>classes/Login.php?f=logout_driver">
