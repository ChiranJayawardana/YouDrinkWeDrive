        ...
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <div class="footer-links">
                    ...
                    <a href="<?php echo base_url ?>?p=about" class="footer-link">
                        <i class="fas fa-info-circle"></i> About Us
                    </a>
                    <a href="<?php echo base_url ?>?p=contact" class="footer-link">
            ...
            <div class="footer-section">
                ...
                <div class="footer-links">
                    ...
                    <a href="./?p=manage_account" class="footer-link">
                    ...
                    <a href="<?php echo base_url ?>register.php" class="footer-link">
