...
<div class="card card-outline card-purple rounded-0">
	...
	<div class="card-body">
		<form action="" id="cab-form" enctype="multipart/form-data">
...
<script>
	// Renamed function to avoid conflicts with other image upload functions
	window.displayDriverImg = function(input,_this) {
	    if (input.files && input.files[0]) {
            ...
            $('#cimg').attr('src', "<?php echo isset($image_path) ? validate_image($image_path) : base_url.'dist/img/no-image-available.png' ?>");
